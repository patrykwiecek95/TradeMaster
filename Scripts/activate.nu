...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Mechanicidea-1\Desktop\Full Stack- Kurs\Django\Nauka\TradeMaster'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Mechanicidea-1\Desktop\Full Stack- Kurs\Django\Nauka\TradeMaster\Scripts\deactivate.nu'
